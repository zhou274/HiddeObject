	...
	public class HOGGameController:MonoBehaviour 
	{
		...
		void CreateLevel()
		{
			...
			if ( edgeLeft && edgeTop && edgeRight && edgeBottom )
			{
				...
				if ( showIconsOnTop == false )
				{
					...
					{
						topBar.Find("Base/FindObjectText").GetComponent<TextMeshPro>().text = topBar.Find("Base/FindObjectText/Shadow").GetComponent<TextMeshPro>().text = "找到 " + numberOfHiddenObjects.ToString() + " " + newObject.GetComponent<HOGHiddenObject>().namePlural;
					}
					else
					{
						topBar.Find("Base/FindObjectText").GetComponent<TextMeshPro>().text = topBar.Find("Base/FindObjectText/Shadow").GetComponent<TextMeshPro>().text = "找到 " + newObject.GetComponent<HOGHiddenObject>().nameArticle + " " + newObject.GetComponent<HOGHiddenObject>().objectName;
					}
				}
				else
				{
					topBar.Find("Base/FindObjectText").GetComponent<TextMeshPro>().text = topBar.Find("Base/FindObjectText/Shadow").GetComponent<TextMeshPro>().text = "";
				}
		...
		void Win()
		{
			...
			if ( topBar )    
			{
				...
				if ( victoryMessage.Length > 0 )    topBar.Find("Base/FindObjectText").GetComponent<TextMeshPro>().text = /*topBar.Find("Base/FindObjectText/Shadow").GetComponent<TextMesh>().text =*/ victoryMessage[Mathf.FloorToInt(Random.Range(0, victoryMessage.Length))];
